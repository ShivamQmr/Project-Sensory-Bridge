...
class_names = []
with open("./ObjectDetection-and-DistanceEstimation/classes.txt", "r") as f:
    class_names = [cname.strip() for cname in f.readlines()]

# Setting up OpenCV net
yoloNet = cv.dnn.readNet('./ObjectDetection-and-DistanceEstimation/yolov4-tiny.weights', './ObjectDetection-and-DistanceEstimation/yolov4-tiny.cfg')
...
ref_person = cv.imread('./ObjectDetection-and-DistanceEstimation/ReferenceImages/person.jpg')
ref_mobile = cv.imread('./ObjectDetection-and-DistanceEstimation/ReferenceImages/mobile.jpg')
ref_bottle = cv.imread('./ObjectDetection-and-DistanceEstimation/ReferenceImages/bottle.jpg')
ref_book = cv.imread('./ObjectDetection-and-DistanceEstimation/ReferenceImages/book.jpg')
ref_car = cv.imread('./ObjectDetection-and-DistanceEstimation/ReferenceImages/car.jpg')
ref_clock = cv.imread('./ObjectDetection-and-DistanceEstimation/ReferenceImages/clock.jpg')
...
WARNING_DISTANCE_THRESHOLD = 0.75  # Adjust this value as needed
prevDistance = 0.00
while True:
    ret, frame = cap.read()
